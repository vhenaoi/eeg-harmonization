...
for sub in subjects:
    ...
    if sub.endswith(suffix,0,3) == True:
        ...
        for v in ses:
            icpowers_json_files = glob.glob(r'E:\Academico\Universidad\Posgrado\Tesis\Datos\BASESDEDATOS\BIOMARCADORES_BIDS\derivatives\sovaflow'+'/'+sub+'/'+v+'\eeg/*_powers.json')
